...
<html>
    ...
    <body>
        <div class="container">
            <div class="row-fluid">
                <ol class="breadcrumb">
                    <li class="active">Mantenimiento y Calibraci&oacute;n</li>
                </ol>
            </div>
            <div class="row-fluid">
                <form action="" class="form-horizontal">
                    <fieldset>
                        ...
                        <div class="form-group">
                            <label for="t1" class="control-label col-md-1">Codigo:</label>
                        ...
                        <div class="form-group">
                            <label for="" class="control-label col-md-1">Temperatura:</label>
                        ...
                        <div class="form-group">
                            <label for="" class="control-label col-md-1">Anotaciones de Ingreso:</label>
                            <div class="col-md-5"><textarea name="" id="" cols="100" rows="5" class="form-control"></textarea></div>
                        </div>
                        <div class="form-group">
                            <label for="" class="control-label col-md-1">Trabajo Realizado:</label>
                            <div class="col-md-5"><textarea name="" id="" cols="100" rows="5" class="form-control"></textarea></div>
                        </div>
                        <div class="form-group">
                            <label for="" class="control-label col-md-1">Diagnostico:</label>
                            <div class="col-md-5"><textarea name="" id="" cols="100" rows="5" class="form-control"></textarea></div>
                        </div>
                        <div class="form-group">
                            <label for="" class="control-label col-md-1">Observaciones:</label>
                            <div class="col-md-5"><textarea name="" id="" cols="100" rows="5" class="form-control"></textarea></div>
                        </div>
                        <div class="form-group">
                            <label for="" class="control-label col-md-1">Equipo de Medici&oacute;n</label>
                            <div class="col-md-2">
